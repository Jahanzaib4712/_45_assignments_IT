...
//exercise 18 : Think of something you could store in a array  :
...
let cities : string[] = ["Karachi", "Mumbai", "Delhi", "Lahore", "Islamabad"];
console.log("list of Cities is given below:");
